...
REM build xerces
xcopy projectfiles\xerces-all shared\builds\xerces-c-3.1.4\projects\Win32\VC14\xerces-all /Y /S
cd shared\builds\xerces-c-3.1.4\projects\Win32\VC14\xerces-all\
MSBuild.exe xerces-all.sln /t:XercesLib /p:Configuration="Static Release" /p:Platform=x64 /m
cd ..\..\..\..\..\..\..\
mkdir libs
