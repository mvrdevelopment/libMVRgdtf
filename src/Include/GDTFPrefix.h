...
namespace VectorworksMVR
{
	namespace GdtfDefines
	{
        ...
        {
            eNodeMissingMandatoryAttribute                  = 0,
            eNodeWrongAttribute                             = 1,
            eNodeWrongName                                  = 2,
            eWheelSlotMissingPNGDirectory                   = 3,
            eModelMissingGeometryDirectory                  = 4,
            eGeometryMissingModelReference                  = 5,
            eGeometryIsNotGeometryReferenceType             = 6,
            eGeometryMissingGeometryObject                  = 7,
            eDmxLogicalChannelMissingName                   = 8,
            eDmxChannelFunctionMissingNextFunction          = 9,
            eDmxChannelFunctionMissingModeMasterChannel     = 10,
            eDmxChannelFunctionMissingModeMasterFunction    = 11,
            eFixtureErrorContainerPointer                   = 12,
            eFixtureWorkingDirDoesNotExist                  = 13,
            eFixtureNoGdtfFileInXmlBuffer                   = 14,
            eFixtureChecksumError                           = 15,
            eFixtureDMXChannelMissingName                   = 16,
            eFixtureLogicalChannelMissingName               = 17,
            eFixtureChannelFunctionMissingName              = 18,
            eFixtureUnresolvedModelRef                      = 19,
            eFixtureUnresolvedGeomRef                       = 20,
            eFixtureMissingActivationGroupPtr               = 21,
            eFixtureMissingAttributeFeature                 = 22,
            eFixtureMissingAttributeMainAttribute           = 23,
            eFixtureMissingDMXModeGeomRef                   = 24,
            eFixtureUnresolvedDMXModeMasters                = 25,
            eFixtureUnresolvedDMXChannelGeomRef             = 26,
            eFixtureUnresolvedDMXChannelGeomPtr             = 27,
            eFixtureUnresolvedDMXLogicalAttrRef             = 28,
            eFixtureUnresolvedChannelFunctionRef            = 29,
            eValueError_UuidHasWrongFormat                  = 30,
            eValueError_ColorHasWrongFormat                 = 31,
            eValueError_DmxAdressHasWrongValue              = 32,
            eValueError_DmxValueHasWrongValue               = 33,
            eValueError_NoMatchInEnum_ConvertPrimitiveType                              = 34,
            eValueError_NoMatchInEnum_ConvertSpecialAttr                                = 35,
            eValueError_NoMatchInEnum_ConvertPhysicalUnit                               = 36,
            eValueError_NoMatchInEnum_ConvertBeamType                                   = 37,
            eValueError_NoMatchInEnum_ConvertLampeType                                  = 38,
            eValueError_NoMatchInEnum_ConvertFrequenz                                   = 39,
            eValueError_NoMatchInEnum_ConvertSnap                                       = 40,
            eValueError_NoMatchInEnum_ConvertMaster                                     = 41,
            eValueError_NoMatchInEnum_ConvertRelation                                   = 42,
            eValueError_NoMatchInEnum_ConvertDMXInvert                                  = 43,
            eValueError_NoMatchInEnum_ConvertEncoderInvert                              = 44,
            eValueError_NoMatchInEnum_ConvertRDMParamType                               = 45,
            eValueError_NoMatchInEnum_ConvertRDMParamDataType                           = 46,
            eValueError_NoMatchInEnum_ConvertRDMParamCommand                            = 47,
            eValueError_NoMatchInEnum_ConvertRDMParamSensorUnit                         = 48,
            eValueError_NoMatchInEnum_ConvertRDMParamSensorUnitPrefix                   = 49,
            eValueError_NoMatchInEnum_ConvertRDMValueBoolValue                          = 50,
            eValueError_NoMatchInEnum_ConvertRDMValueThresholdOperator                  = 51,
            eValueError_NoMatchInEnum_ConvertRDMValueSensorDefinitionType               = 52,
            eValueError_NoMatchInEnum_ConvertRDMValueLowesHighestDetectionSupported     = 53,
            eValueError_NoMatchInEnum_ConvertRDMValueRecordValueSupported               = 54,
            eValueError_NoMatchInEnum_ConvertRDMValueSlotInfoType                       = 55,
            eValueError_NoMatchInEnum_ConvertRDMValueSlotInfoSlotLabelID                = 56,
            eValueError_NoMatchInEnum_ConvertColorSample                                = 57,
            eValueError_MatrixFormatError                           = 58,
            eValueError_MatrixFormatMissingFirstBracket             = 59,           
            eValueError_MatrixFormatMissingLastBracket              = 60,
            eValueError_MatrixFormatMissingMiddleBrackets           = 61,
            eValueError_MatrixFormatTooMuchOrTooLessLines           = 61,
            eValueError_MatrixFormatTooMuchOrTooLessEntries         = 62,
            eValueError_MatrixRotationFormatMissingFirstBracket     = 63,
            eValueError_MatrixRotationFormatMissingLastBracket      = 64,
            eValueError_MatrixRotationFormatMissingMiddleBrackets   = 65,
            eValueError_MatrixRotationTooMuchOrTooLessLines         = 66,
            eValueError_MatrixRotationTooMuchOrTooLessEntries       = 67,
            eValueError_NoCommaFound        = 68,
            eFailedToReadDescription        = 69,
            eXmlParsingError                = 70,
        };
