...
namespace VectorworksMVR
{
	namespace GdtfDefines
	{
        ...
        enum class EGdtfParsingError : Sint32
        {
            ...
            eDmxChannelSet                                  = 21,
            eFixture                                        = 22,
            eFixtureErrorContainerPointer                   = 23,
            eFixtureWorkingDirDoesNotExist                  = 24,
            eFixtureNoNameDMXChannel                        = 25,
            eFixtureNoNameLogicalChannel                    = 26,
            eFixtureNoNameChannelFunction                   = 27,
            eFixtureUnresolvedModelRef                      = 28,
            eFixtureUnresolvedGeomRef                       = 29,
            eFixtureUnresolvedAttributeActGroup             = 30,
            eFixtureUnresolvedAttributeFeature              = 31,
            eFixtureUnresolvedAttributeMainAttribute        = 32,
            eFixtureUnresolvedDMXModeGeomRef                = 33,
            eFixtureUnresolvedDMXModeMasters                = 34,
            eFixtureUnresolvedDMXChannelGeomRef             = 35,
            eFixtureUnresolvedDMXChannelGeomPtr             = 36,
            eFixtureUnresolvedDMXLogicalAttrRef             = 37,
            eFixtureReadGeom                                = 38,
