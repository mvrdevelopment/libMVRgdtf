...
VectorworksMVR::VCOMError VectorworksMVR::CMediaRessourceVectorImpl::CreateSpeakerBumper(const MvrUUID& guid, const STransformMatrix& offset, MvrString name, ISceneObj* addToContainer, ISceneObj** outSpeaker)
{
	//---------------------------------------------------------------------------
	// Read Container
	CSceneObjImpl* pContainer = static_cast<CSceneObjImpl* >(addToContainer);
	...
	SceneData::SceneDataSpeakerBumperObjPtr ptr = fExchangeObj.CreateSpeakerBumper(uuid, ma, nameStr, group);
