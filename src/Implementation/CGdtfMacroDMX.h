...
{    
    class CGdtfMacroDMXImpl : public VectorworksMVR::VCOMImpl<IGdtfMacroDMX>
    {
    public:
        CGdtfMacroDMXImpl();
        ...
        virtual VCOMError VCOM_CALLTYPE    CreateStep(Sint32& macroDuration, IGdtfMacroDMXStep** outStep);
