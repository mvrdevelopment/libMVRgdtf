...
MVRxchangeClient::MVRxchangeClient(const MVRxchangePacket& packet, std::shared_ptr<boost::asio::io_context> io_context)
    : fMsg_send(packet), fio_context(io_context), fSocket(*io_context)
{
}
